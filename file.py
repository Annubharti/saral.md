        import requests
                ...
                def choose_course():
                        ...
                        user_choice = int(input("Choose the Course number which you want to learn./n Your answer : "))
                ...
                exercise_json = request(BASE_URL+'/'+str(user_choice)+"/exercises")
                exercises = request(exercise_json)
